...
#define SBK_QTWIDGETS_QLIST_QRECTF_IDX                               11 // const QList<QRectF > &
#define SBK_QTWIDGETS_QLIST_QOBJECTPTR_IDX                           12 // const QList<QObject* > &
#define SBK_QTWIDGETS_QLIST_QBYTEARRAY_IDX                           13 // QList<QByteArray >
#define SBK_QTWIDGETS_QLIST_QGRAPHICSVIEWPTR_IDX                     14 // QList<QGraphicsView* >
#define SBK_QTWIDGETS_QLIST_QABSTRACTBUTTONPTR_IDX                   15 // QList<QAbstractButton* >
#define SBK_QTWIDGETS_QLIST_QUNDOSTACKPTR_IDX                        16 // QList<QUndoStack* >
...
#define SBK_QTWIDGETS_QLIST_QTABLEWIDGETITEMPTR_IDX                  24 // QList<QTableWidgetItem* >
#define SBK_QTWIDGETS_QLIST_QTABLEWIDGETSELECTIONRANGE_IDX           25 // QList<QTableWidgetSelectionRange >
#define SBK_QTWIDGETS_QMAP_QDATE_QTEXTCHARFORMAT_IDX                 26 // QMap<QDate,QTextCharFormat >
#define SBK_QTWIDGETS_QLIST_QWIZARD_WIZARDBUTTON_IDX                 27 // const QList<QWizard::WizardButton > &
#define SBK_QTWIDGETS_QLIST_QWINDOWPTR_IDX                           28 // QList<QWindow* >
#define SBK_QTWIDGETS_QLIST_QSCREENPTR_IDX                           29 // QList<QScreen* >
#define SBK_QTWIDGETS_QLIST_QGRAPHICSWIDGETPTR_IDX                   30 // QList<QGraphicsWidget* >
#define SBK_QTWIDGETS_QLIST_QKEYSEQUENCE_IDX                         31 // const QList<QKeySequence > &
...
#define SBK_QTWIDGETS_QPAIR_QREAL_QPOINTF_IDX                        35 // QPair<qreal,QPointF >
#define SBK_QTWIDGETS_QLIST_QPAIR_QREAL_QPOINTF_IDX                  36 // QList<QPair< qreal,QPointF > >
#define SBK_QTWIDGETS_QPAIR_QREAL_QREAL_IDX                          37 // QPair<qreal,qreal >
#define SBK_QTWIDGETS_QLIST_QPAIR_QREAL_QREAL_IDX                    38 // QList<QPair< qreal,qreal > >
#define SBK_QTWIDGETS_QLIST_QABSTRACTANIMATIONPTR_IDX                39 // QList<QAbstractAnimation* >
#define SBK_QTWIDGETS_QLIST_QABSTRACTSTATEPTR_IDX                    40 // const QList<QAbstractState* > &
#define SBK_QTWIDGETS_QLIST_QTEXTEDIT_EXTRASELECTION_IDX             41 // QList<QTextEdit::ExtraSelection >
#define SBK_QTWIDGETS_QLIST_QURL_IDX                                 42 // QList<QUrl >
