...
#define SBK_QTCORE_QLIST_QABSTRACTEVENTDISPATCHER_TIMERINFO_IDX      35 // QList<QAbstractEventDispatcher::TimerInfo >
#define SBK_QTCORE_QLIST_QURL_IDX                                    36 // const QList<QUrl > &
...
#define SBK_QTCORE_QLIST_QABSTRACTANIMATIONPTR_IDX                   39 // QList<QAbstractAnimation* >
#define SBK_QTCORE_QLIST_QABSTRACTSTATEPTR_IDX                       40 // const QList<QAbstractState* > &
